...
`.env` keys: `BOT_TOKEN`, `POLL_INTERVAL` (seconds between exchange polls, default 300 — kept high with jitter to avoid tripping kwork's anti-bot rate limiting), `DB_PATH`, `SEED_CHAT_ID` (optional chat auto-registered on startup).
